        ...
        methods: {
            ...
            hidePop(data) {
                if (this.currentSalary) {
                    this.putRequest('/salary/sob/cfg/?eid=' + data.id + '&sid=' + this.currentSalary).then(resp => {
                        if (resp) {
                            this.initEmps()
                        }
                    });
            ...
            initEmps() {
                this.getRequest("/salary/sob/cfg/?currentPage=" + this.currentPage + '&pageSize=' + this.pageSize).then(resp => {
                    if (resp) {
                        this.emps = resp.data;
